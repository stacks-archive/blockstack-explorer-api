...
test('fetches block info', async () => {
  const hash = '00000000000000000010eb9ebfa53e0938a8247e8309d1abc026d8f82eecfb67';
  const height = 550348;
...
test('fetches blocks on a date', async () => {
  ...
  expect(block.hash).toEqual('00000000000000000005128450e606b6df5360dfb091f2b4fd809f8647821967');
